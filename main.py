...
def extract_information(search_results, entity):
    prompt = f"Extract the required information for {entity} from the following web results: {search_results}"
...
def main():
    ...
    if uploaded_file is not None:
        ...
        query_template = st.text_input("Define your query", "Get me the information for {entity}")
